...
export default function Layout(props){
    return(
        <>
        <header className='p-4 pb-0 flex justify-between items-center sm:p-6 sm:pb-0 md:px-28 md:pt-12'>
            ...
            <button 
                ...
                className='relative cursor-pointer bg-Neutal-800 hover:bg-Neutral-700 focus:outline-1 focus:outline-Neutral-0 focus:outline-offset-2 rounded-sm flex items-center gap-1.5 px-2.5 py-2 sm:px-4 sm:py-3'
            >
            ...
            <div className='absolute top-24 right-46 grid gap-2 px-2 py-1.5 rounded-xl bg-Neutal-800 w-[214px]'>
                <button 
        ...
        <footer className='border-Orange-500 border-t-[0.1px] py-4 mx-4 text-preset-8 text-center text-Neutral-200 sm:mx-6 sm:text-preset-7 md:mx-28'>
            Challenge by <a 
